...
import { Sparkles, Clock, User, Phone, CheckCircle, Stethoscope, Mail, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db, 'sessions'), {
        ...
        status: 'Programada',
        type: 'online-booking',
        notes: `Registro web automático. DNI: ${formData.dni}`,
        createdAt: new Date().toISOString()
      });
          ...
          <div className="p-6 bg-slate-50/30">
            {selectedSlot ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" className="w-full bg-blue-600 text-white py-4 rounded-xl font-bold shadow-lg hover:bg-blue-700 transition-all mt-4 uppercase tracking-widest text-sm">
